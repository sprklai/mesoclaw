...
pub struct SettingsRow {
    ...
    pub notify_cron_reminder: i32,
    pub notify_agent_complete: i32,
    pub notify_approval_request: i32,
...
impl Settings {
    ...
    pub fn from_row(row: SettingsRow) -> Result<Self, DbError> {
        ...
        Ok(Self {
            ...
            notify_cron_reminder: int_to_bool(row.notify_cron_reminder),
            notify_agent_complete: int_to_bool(row.notify_agent_complete),
            notify_approval_request: int_to_bool(row.notify_approval_request),
...
pub struct SettingsUpdate {
    ...
    pub notify_cron_reminder: Option<bool>,
    pub notify_agent_complete: Option<bool>,
    pub notify_approval_request: Option<bool>,
...
pub struct SettingsChangeset {
    ...
    pub notify_cron_reminder: Option<i32>,
    pub notify_agent_complete: Option<i32>,
    pub notify_approval_request: Option<i32>,
    pub temperature: Option<f32>,
    pub max_tokens: Option<i32>,
    pub timeout: Option<i32>,
...
impl From<SettingsUpdate> for SettingsChangeset {
    fn from(update: SettingsUpdate) -> Self {
        Self {
            ...
            notify_cron_reminder: update.notify_cron_reminder.map(bool_to_int),
            notify_agent_complete: update.notify_agent_complete.map(bool_to_int),
            notify_approval_request: update.notify_approval_request.map(bool_to_int),
